...
AFRAME.registerComponent('web-portal', {
    schema: {
        ...
        enableReturnButton: { default: false },
        enableCollisionDetection: { default: false },
        enableOnClickTransition: { default: true },
    },
    ...
    init: function() {
        ...
        if (data.enableFrame == true) {
            ...
            // @ts-ignore
            box4.setAttribute('material', { src: '#IThreeM__NeighborVisualization__Webportal_' });
            el.appendChild(box4);
        };
      ...
      button:hover {
        ...
        if (data.enableCollisionDetection) {
